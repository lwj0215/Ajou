...
public class Main {
    ...
    public static void makeReservation(){
        ...
        //     return;
        // }
        int carIndex = findVehicle();
        if(carIndex == 0 ){
            System.out.println("No cars satisfying conditions");
            return;
        }
        reservationList.add(new Reservation(carIndex, year, month, day, period, name, hp));
    ...
    public static Car findVehicle(char clas, Date date, int period){
